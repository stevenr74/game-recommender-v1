...
// FOR DATABASE VERSION 2.0~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

function initialGames(){
	var data = <?php json_encode(GetData(), JSON_HEX_TAG); ?>;
	console.log(data[0]);
	...
	for (var i=0; i < 6; i++){
		...
		optionSelection.setAttribute("data-img-src", matches[i].img); //get db array values
		optionSelection.setAttribute("value", i+1); //change as well
